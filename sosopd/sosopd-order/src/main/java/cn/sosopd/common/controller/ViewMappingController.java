...
@Controller
@RequestMapping(SysConstants.REQUEST_URL_PREFIX)
@SuppressWarnings("unchecked")
public class ViewMappingController {

	/** URL请求的前缀 */
	protected static final String REQUEST_URL_PREFIX = SysConstants.REQUEST_URL_PREFIX;
	/** 视图文件目录前缀 */
	protected static final String VIEWS_PATH_PREFIX = SysConstants.REQUEST_URL_PREFIX;
